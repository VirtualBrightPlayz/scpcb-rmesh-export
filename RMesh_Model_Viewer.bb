...
Type XE_texdata
	Field idx,h,fn$
End Type
Function writemesh(mesh,e_dirname$,e_filenames$)

	Local e_filename$ = e_dirname$+e_filenames$
	...
	RecursiveAddMaterial(mesh,"",e_dirname$)
	...
	If trunc
       ...
       ;fileW=OpenFile ("temp."+filenameout)
